...
if ( ! function_exists('sources'))
{
	...
	<link
		...
		rel='stylesheet' />
	<link href='localhost://pruebacodeigniter/richtext/external/google-code-prettify/prettify.css' rel='stylesheet'/>
	<script src='localhost://pruebacodeigniter/richtext/external/jquery.hotkeys.js'></script>
	<script src='localhost://pruebacodeigniter/richtext/external/google-code-prettify/prettify.js'></script>
	<link href='localhost://pruebacodeigniter/richtext/css/style.css' rel='stylesheet' />
	<script src='localhost://pruebacodeigniter/richtext/src/bootstrap-wysiwyg.js'></script>";
